...
if [ "$CHECK" = true ]; then
  ...
  determine_exit_code $?
  python3 gatorgrader/gatorgrader.py --directories src/www  --checkfiles index.html
  determine_exit_code $?
  python3 gatorgrader/gatorgrader.py --directories images  --checkfiles screenshot.png
  determine_exit_code $?  echo ""
